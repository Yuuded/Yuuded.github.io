...
login = function() {
	...
	*/
	...
	window.parent.postMessage(username.val(), "http://localhost/serverManagement/index.html");
	/*
...
function changeToRegister() {
	changePage("register_tmp.html");
}

//Doesn't have any verification. TODO: Verification
function loginNew() {
